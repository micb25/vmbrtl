...
// -----------------------------------------------------------------------------
//  VCL_ButtonMember(hwnd, int) - ändert einen Member 
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// VCL_ButtonProc(int, int, int, int) - Callback für Buttons
// -----------------------------------------------------------------------------
LRESULT CALLBACK VCL_ButtonProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{    
     VMBVar *VCLCom;
...
// -----------------------------------------------------------------------------
// VCL_ButtonUpdateFont(PROP, HWND) - Verändert den Font des Buttons
// -----------------------------------------------------------------------------
void VCL_ButtonUpdateFont(VCLButtonProperties *Prop, HWND hwnd)
{
